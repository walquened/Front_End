            ...
            <div class="container">
                ...
                <nav class="grid-12 header_menu">
                    ...
                    <ul>
                        ...
                        <li><a href="portfolio.php" title="Portfólio" class="menu_ativo">Portfólio</a></li> 
            ...
            <ul class="rslides">
                <li>
                    <blockquote class="quote_clientes">
                        <p> TRETA Mulheres: feitas de sonhos, de força, amor e inspiração. 
                            Cheias de vida, dotadas de valor, retrato fiel do cuidado devotado,
                            da intuição, da fortaleza imposta nas lutas diárias, em cada palavra e em cada olhar. </p>
                        <cite>Barbara  Moss</cite>
                    </blockquote>
                </li>
                <li>
                    <blockquote class="quote_clientes">
                        <p>Mulheres: feitas de sonhos, de força, amor e inspiração. 
                            Cheias de vida, dotadas de valor, retrato fiel do cuidado devotado,
                            da intuição, da fortaleza imposta nas lutas diárias, em cada palavra e em cada olhar. </p>
                        <cite>Cross Montes</cite>
                    </blockquote>
                </li>
                <li>
                    <blockquote class="quote_clientes">
                        <p>B+ Mulheres: feitas de sonhos, de força, amor e inspiração. 
                            Cheias de vida, dotadas de valor, retrato fiel do cuidado devotado,
                            da intuição, da fortaleza imposta nas lutas diárias, em cada palavra e em cada olhar. </p>
                        <cite>Felipes</cite>
                    </blockquote>
